...
# Contextual compression and retrieval
...
# LLM providers (with emojis or markdown styling)
LLM_PROVIDERS = [
    ":rainbow[**OpenAI**]",
...
def expander_model_parameters(
    ...
    """Render model/API key input and model parameter sliders in an expandable section."""
    ...
    with st.expander("**Models and parameters**"):
        st.session_state.selected_model = st.selectbox(
            f"Choose a {LLM_provider} model", list_models
        )
